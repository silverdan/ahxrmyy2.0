...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by DTcms Template Engine at 2015/8/28 17:20:07.
		本页面代码由DTcms模板引擎生成于 2015/8/28 17:20:07. 
	*/
	...
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/images/bj_ico03.gif\" width=\"7\" height=\"11\" /></span><em><a href=\"#\"><img src=\"");
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/images/more_01.jpg\" width=\"50\" height=\"18\" alt=\"更多\" title=\"更多\" /></a></em>科室简介</h3>\r\n			        <ul>\r\n			          <p id=\"tempContent\">\r\n			          ");
	if (category_id!=0)
	{

	templateBuilder.Append("	");
	templateBuilder.Append(Utils.ObjectToStr(get_category_model(category_id).content));
	}
	else
	{

	templateBuilder.Append("所有科室");
	}	//end for if

	templateBuilder.Append("\r\n			          </p>\r\n			        </ul>\r\n			    </div>\r\n                <div class=\"Doctors\">\r\n						<h3><span><img src=\"");
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/images/bj_ico03.gif\" alt=\"a\" width=\"7\" height=\"11\" /></span><em><a href=\"#\">\r\n							<img src=\"");
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/images/more_01.jpg\" width=\"50\" height=\"18\" alt=\"更多\" title=\"更多\" /></a></em>专家介绍</h3>\r\n						<div class=\"DoctorsPoint\">\r\n							<div id=\"DoctorsList\">\r\n								<ul>\r\n									<!--此处为医师列表-->\r\n									");
	...
	templateBuilder.Append("\"><img src=\"" + Utils.ObjectToStr(dr["img_url"]) + "\" width=\"114\" height=\"171\" alt=\"" + Utils.ObjectToStr(dr["title"]) + "\" title=\"\" />" + Utils.ObjectToStr(dr["title"]) + "</a>\r\n					                </li>\r\n					                ");
	}	//end for if
